...
(custom-set-variables
 ...
 '(ansi-color-names-vector
   ["#000000" "#c73c3f" "#73c936" "#ffdd33" "#95a99f" "#9e95c7" "#96a6c8"
    "gray90"])
 '(bongo-enabled-backends '(vlc mpv speexdec))
 ...
 '(org-capture-templates
   '(("p" "Capture task" entry (file "~/Documents/Agenda/Tasks.org")
     ...
     ("K" "Cliplink capture task" entry
      ...
      "* TODO %(org-cliplink-capture) \12  SCHEDULED: %t\12")
     ("d" "Définitions" entry
      (file+headline "~/Documents/org/references.org" "Définitions")
      "* %?" :empty-lines 1)
     ("n" "Notes" entry
      (file+headline "~/Documents/Agenda/notes.org" "Notes")
      "** %? %T" :empty-lines 1)) t)
 '(package-selected-packages
   '(all-the-icons-ivy-rich bongo browse-at-remote company consult
                            counsel diminish dired-git-info dired-open
                            dired-preview dired-subtree drag-stuff
                            eldoc-box elfeed elfeed-goodies embark
                            emms eshell-syntax-highlighting
                            eshell-toggle expand-region flycheck
                            go-mode highlight-numbers htmlize
                            htmlize-mode imenu-list ivy-prescient
                            keycast ledger-mode lua-mode magit
                            marginalia markdown-mode mct
                            multiple-cursors nano-mu4e
                            nerd-icons-completion nerd-icons-dired
                            nerd-icons-ibuffer nerd-icons-ivy-rich
                            orderless ox-rfc paredit pdf-tools
                            php-mode projectile rainbow-delimiters
                            rainbow-mode rfc-mode scratch sed-mode
                            shr-tag-pre-highlight shrface sudo-edit
                            tldr toc-org treesit-auto vertico vterm
                            vterm-toggle yasnippet-snippets ytdious))
 '(safe-local-variable-values
   '((fill-column) (Fill-Column . 90) (whitespace-mode)
     (code . utf-8-unix) (eval outline-hide-sublevel: 2)
     (code . utf8-emacs-unix) (eval outline-hide-sublevels 1)
...
(custom-set-faces
 ...
 '(eww-form-select ((t (:background "    black" :foreground "white" :box (:line-width (2 . 2) :style released-button)))))
 '(eww-form-submit ((t (:background "#242424" :foreground "#efefef" :box (:line-width (2 . 2) :style released-button)))))
 '(eww-form-text ((t (:background "#181818 \12" :foreground "#e4e4fe" :box (1 . 1)))))
 ...
 '(gnus-header-from ((t (:inherit gnus-header :foreground "cornsilk"))))
 '(gnus-header-name ((t (:inherit gnus-header :foreground "white smoke"))))
 ...
 '(org-level-6 ((t (:inherit outline-5 :extend nil :foreground "#565f73" :height 1.2))))
 ...
 '(shr-code ((t (:inherit fixed-pitch :family "IosevkaTerm Nerd Font"))))
