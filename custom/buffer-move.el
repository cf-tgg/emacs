...
If there is no split, i.e. no window above the current one, an
error is signaled."
  (interactive)
...
If there is no split, i.e. no window under the current one, an
error is signaled."
  (interactive)
...
If there is no split, i.e. no window on the left of the current
